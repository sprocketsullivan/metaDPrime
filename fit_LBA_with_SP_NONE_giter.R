...
help.data<-subset(help.data,norm3=="NONE")
...
p.map <- list(A="1",B="R",mean_v="M",sd_v="1",t0="1",st0="1")
...
p.prior <- prior.p.dmc(
  ...
  p1=c(A=.3,B.r1=0.3,B.r2=0.3,mean_v.true=1,mean_v.false=0,t0=1),                           
  p2=c(1,1,1,3,3,1),lower=c(0,0,0,NA,NA,.1),upper=c(NA,NA,NA,NA,NA,1)
)
